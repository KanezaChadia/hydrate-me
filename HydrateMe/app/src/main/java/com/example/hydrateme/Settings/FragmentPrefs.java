...
import com.example.hydrateme.SignInActivity;
...
public class FragmentPrefs extends PreferenceFragment
    ...
    private Preference glassSizePref, bottleSizePref, intervalPref, soundPref,
            notiEnablePref,fromTimePrf, toTimePref,weightPref,trainingPref,waterNeedPref,logout;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.settings_prefs_screen);
        ...
        logout = findPreference(PreferenceKey.LOGOUT);
        ...
        logout.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    intent = new Intent(getContext().getApplicationContext(), SignInActivity.class);
                }
    ...
    private void initSummaries() {
        ...
        String from = sharedPreferences.getString(PreferenceKey.FROM_KEY,"7:00");
        String to = sharedPreferences.getString(PreferenceKey.TO_KEY,"20:00");
          if(weight!=0)
             weightPref.setSummary(Integer.toString(weight)+" lb");
        trainingPref.setSummary(getString(training));
        waterNeedPref.setSummary(Integer.toString(water_reco)+" oz");
        glassSizePref.setSummary(glassSize+ " oz");
        bottleSizePref.setSummary(bottleSize+ " oz");
    ...
    TimePickerDialog.OnTimeSetListener timeFrom = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            fromTimePrf.setSummary(hourOfDay +":"+ minute);
            setTimePref(PreferenceKey.FROM_KEY, hourOfDay +":"+ minute);
    ...
    TimePickerDialog.OnTimeSetListener timeTo = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            toTimePref.setSummary(hourOfDay +":"+ minute);
            setTimePref(PreferenceKey.TO_KEY, hourOfDay +":"+ minute);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        switch (preference.getKey()) {
            ...
            case PreferenceKey.PREF_WATER_NEED:
                preference.setSummary(newValue.toString()+ " oz");
                return true;
    ...
    private void handleTrainingPrefs(String s, Preference preference) {
        ...
        waterNeedPref.setSummary(String.valueOf(waterNeedValue) +" oz");
    }
    ...
    private void handleWeightPref(String s, Preference preference) {
        ...
        preference.setSummary(s+" lb");
        waterNeedPref.setSummary(value +" oz");
    }
