...
public class FragmentPrefs extends PreferenceFragment
    ...
    private Preference glassSizePref, bottleSizePref, intervalPref, soundPref, notiEnablePref,
            fromTimePrf, toTimePref,weightPref,trainingPref,waterNeedPref,logout;
    ...
    private void handleWeightPref(String s, Preference preference) {
        ...
        waterNeedPref.setSummary(String.valueOf(value) +" oz");
    }
