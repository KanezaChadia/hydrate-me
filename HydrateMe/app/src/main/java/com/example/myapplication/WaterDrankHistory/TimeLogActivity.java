...
import com.example.myapplication.MainWindow.TimePickerFragment;
import com.example.myapplication.Model.TimeLog;
...
public class TimeLogActivity extends AppCompatActivity implements View.OnClickListener, NumberPicker.OnValueChangeListener , TimePickerFragment.OnTimePickedListener {
    ...
    Button  cancel, glassButton, bottleButton, setButton,setButtonInUpdateDialog,updateToOtherSize, cancelUpdateDialog, glassButtonInUpdateDialog, bottleButtonInUpdateDialog;
    ...
    private void loadContainerSizePrefs() {
        ...
        glassButton.setText(glassSizeV+ " oz");
        bottleButton.setText(bottleSizeV+ " oz");
        glassButtonInUpdateDialog.setText(glassSizeV+ " oz");
        bottleButtonInUpdateDialog.setText(bottleSizeV+ " oz");
    ...
    private class myListAdapter extends ArrayAdapter<TimeLog> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            waterLog.setText(values.get(position).getAmount() + " oz");
...
//                return true;
    ...
    private void updateViews(){
        MainActivity.choosenAmountTv.setText(String.valueOf(db.geConsumedWaterForTodayDateLog()
                +" out of "+ PrefsHelper.getWaterNeedPrefs(getApplicationContext()))+" oz");
        adapter.clear();
